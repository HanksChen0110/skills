...
- ✅ User cognition principles applied (System 1 alignment)
- ✅ Designer biases checked (System 2 in process)
- ✅ External benchmarks referenced
- ✅ Diverse user feedback collected
- ✅ Statistical thinking applied
- ✅ Both experience and memory measured
- ✅ Multiple design directions explored
- ✅ Premortem analysis conducted
...
- 🚩 You're only seeing positive feedback (confirmation bias)
- 🚩 Recent feedback is dominating decisions (availability bias)
- 🚩 You're ignoring industry benchmarks (base rate neglect)
- 🚩 You're overconfident about user adoption (overconfidence)
- 🚩 You haven't done a premortem (planning fallacy)
- 🚩 You're anchored to initial design ideas (anchoring)
