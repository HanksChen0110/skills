...
### Step 1: 准备垫图
读 `references/01_导出方法.md` — PPT 导出为图片

### Step 2: 分析模板
读 `references/02_PPT模板分析方法.md` — 输出布局库

### Step 3: 规划内容
读 `references/03_内容分段方法.md` — 确定每页放什么
...
详见 `references/04_内容映射方法.md` 的"表达形式设计"章节

### Step 4: 映射+提示词
读 `references/04_内容映射方法.md` — 内容匹配布局，生成提示词

> **提示词规范**见 `references/02_PPT模板分析方法.md` 第六章
...
| 文件 | 地位 | 功能 |
|------|------|------|
| `references/01_导出方法.md` | 阶段1 | PPT 导出为图片（垫图） |
| `references/02_PPT模板分析方法.md` | 阶段2 | 分析模板，输出布局库 |
| `references/03_内容分段方法.md` | 阶段3 | 内容拆分为页面 |
| `references/04_内容映射方法.md` | 阶段4 | 内容匹配布局，生成提示词 |
| `references/05_图床上传方法.md` | 工具 | 图床上传获取 URL |
